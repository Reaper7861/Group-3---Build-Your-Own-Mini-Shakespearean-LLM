...
| Come, cousin, canst thou quake, | Gemini Flash | **High** - complete grammatical sentences develop a consistent dramatic situation. | **High** - “borrowed robes,” “honest blood,” and “silent shame” sustain an Elizabethan dramatic voice. | **No obvious loop** - the continuation develops its ideas without repeated fragments. |
...
| Now is the winter of our discontent | Gemini Flash | **High** - fluent verse maintains stable grammar and line structure. | **High** - the response continues Richard III with authentic dramatic rhythm and diction. | **No obvious loop** - the passage progresses without repeated wording. |
...
| To be or none or little; | Gemini Flash | **High** - a coherent sequence of grammatical lines develops the prompt into a complete idea. | **High** - “dying light,” “mortal strife,” and the measured cadence sustain an Elizabethan tone. | **No obvious loop** - no phrase or short-word cycle appears. |

### Production-model method

The production baseline is **Gemini Flash**, evaluated on the four lines in `evaluation/prompts.txt`. It was asked to continue each line in Shakespearean style, preserve the original line, and generate **exactly 150 output tokens** per continuation, excluding the seed line and section label. No character limit was used. All four plain-text results are saved together in `evaluation/outputs/gemini_flash.txt`.
